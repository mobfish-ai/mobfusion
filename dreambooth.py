...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=".txt",
        required=False,
        help="The extension of caption file",
    )
    parser.add_argument(
        "--class_prompt",
        type=str,
    ...
    parser.add_argument(
        "--use_8bit_lion",
        action="store_true",
        help="Whether or not to use 8-bit Lion from bitsandbytes.",
    )
    parser.add_argument(
...
def main(args):
    ...
    elif args.use_8bit_lion:
        try:
            import bitsandbytes as bnb
        except ImportError:
            raise ImportError(
                "To use 8-bit Lion, please install the bitsandbytes library: `pip install bitsandbytes`."
            )
